(ns tables.ver01.routes.user
  (:require [compojure.core :refer [routes GET POST]]
            ...
            [tables.ver01.layout :as layout]
            [tables.ver01.db.user :as db]
            [tables.ver01.service.user :as uservice]
            [tables.ver01.service.auth :as auth]
