(ns pickaseat.ver01.components.handler
  (:require [compojure.core :refer [defroutes]]
            ...
            [pickaseat.ver01.routes.home :refer [home-routes]]
            [pickaseat.ver01.routes.cc :refer [cc-routes]]
            [pickaseat.ver01.routes.user :refer [user-routes registration-routes]]
            [pickaseat.ver01.middleware :refer [load-middleware]]))
