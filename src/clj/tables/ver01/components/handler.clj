(ns tables.ver01.components.handler
  (:require [compojure.core :refer [defroutes]]
            ...
            [tables.ver01.routes.home :refer [home-routes]]
            [tables.ver01.routes.cc :refer [cc-routes]]
            [tables.ver01.routes.user :refer [user-routes registration-routes]]
            [tables.ver01.middleware :refer [load-middleware]]))
